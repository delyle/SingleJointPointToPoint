function f = Otten_fl_even(L,b)
% this function computes the normalized isometric contractile force for a given
% length according to a Hill-type model parameterized by Otten 1985 with
% an even value for b[1]. This allows for the absolute value to be removed
%
% f = exp( -([L^b(2) - 1]/b(3) ).^b(1) ), L >= 0
% 
